...
Contributions are welcome. `go-ruby-i18n/i18n` is built to a small set of
...
The library is in [`github.com/go-ruby-i18n/i18n`](https://github.com/go-ruby-i18n/i18n).
This documentation site is in [`github.com/go-ruby-i18n/docs`](https://github.com/go-ruby-i18n/docs).
