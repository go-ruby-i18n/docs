...
`go-ruby-i18n/i18n` reimplements Ruby's `i18n` in **pure Go, with cgo disabled**. The slice of
...
- any Go program can import `github.com/go-ruby-i18n/i18n` directly, with no Ruby runtime;
