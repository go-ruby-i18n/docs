...
The public API lives at the module root (`github.com/go-ruby-i18n/i18n`). It is
**Ruby-shaped but Go-idiomatic**: names mirror Ruby's `i18n`, while the surface follows
...
```go
import "github.com/go-ruby-i18n/i18n"
```
...
- **[pkg.go.dev/github.com/go-ruby-i18n/i18n](https://pkg.go.dev/github.com/go-ruby-i18n/i18n)**

The module's [README](https://github.com/go-ruby-i18n/i18n#readme) carries worked
