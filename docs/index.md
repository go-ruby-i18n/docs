# go-ruby-i18n documentation

**Pure-Go, MRI-4.0.5-faithful Ruby i18n (no cgo)**

`go-ruby-i18n/i18n` is a faithful, pure-Go (zero cgo) reimplementation of Ruby's `i18n`,
...
!!! success "Status: pure-Go, CGO=0, differential-tested"
    A faithful pure-Go port of Ruby's `i18n`, validated against reference Ruby, at 100%
...
| Repo | What it is |
| --- | --- |
| [`i18n`](https://github.com/go-ruby-i18n/i18n) | the library — Ruby's `i18n` in pure Go |
| [`docs`](https://github.com/go-ruby-i18n/docs) | this documentation site (MkDocs Material, versioned with mike) |
| [`go-ruby-i18n.github.io`](https://github.com/go-ruby-i18n/go-ruby-i18n.github.io) | the organization landing page (Hugo) |
| [`brand`](https://github.com/go-ruby-i18n/brand) | logo and brand assets |
...
Source lives at [github.com/go-ruby-i18n/i18n](https://github.com/go-ruby-i18n/i18n).
